...
| ---------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------- | ---------------- |
| `disableOverlay` | `disable-overlay` | The overlay is usefull to prevent user interactions behind the backdrop when the product tour is open. It can be disabled if the highlighted target element need to be interactive but one of its parent node has his own stacking context. Then the whole page will be interactive. | `boolean`                                | `false`          |
