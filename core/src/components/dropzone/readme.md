...
| `descriptionText`       | `description-text`        | Add description Text                                                    | `string`                      | `'Drop your file here or'`   |
...
| --------------------------------- | ----------- | ----------------------------- |
| `joy-dropzone-buttons-click`      |             | `CustomEvent<null>`           |
| `joy-dropzone-cancel-upload-file` |             | `CustomEvent<File[] \| null>` |
| `joy-dropzone-dropped-files`      |             | `CustomEvent<File[] \| null>` |
